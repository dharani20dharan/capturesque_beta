    ...
    <section className="intro">
      <div className="intro-content">
        ...
        <p className="intro-highlight">
          Students can log in to unlock personalized galleries and see their images.
          <strong>Now Students can get access to download the images by Logging in.</strong>
        </p>
